    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          id: 'pr-sqlglot',
          label: 'SQLGlot #8257',
          hint: 'DuckDB array AST nodes',
          icon: GitPullRequest,
          run: () => 'https://github.com/tobymao/sqlglot/pull/8257',
        },
        {
          id: 'pr-sympy',
          label: 'SymPy #30384',
          hint: 'Decorator typing',
          icon: GitPullRequest,
          run: () => 'https://github.com/sympy/sympy/pull/30384',
        },
      ],
    },
    {
